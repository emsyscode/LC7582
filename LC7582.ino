...
#define Green 11  //This pin is to activate the backlight Ambar
#define Ambar 12  //This pin is to activate the backlight Green
...
send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 40:33  -48:41//  
send_char_without(0B00101110);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
//Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
//Note: the Dq is to define the pins to Segments or Analog pins
//Last  bit is to define first group or second! 
delayMicroseconds(2);
...
digitalWrite(VFD_ce, HIGH); //
// On the 7582 of Sanyo the message 
send_char_without(0B00001101);  send_char_without(0B00000000); // 64:57  -72:65//  
...
digitalWrite(VFD_ce, HIGH); //
// On the 7582 of Sanyo the message 
send_char_without(0B00000101);  send_char_without(0B00000000); // 64:57  -72:65//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 80:73  -88:81//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 96:89 -104:97//  
send_char_without(0B10000000);  //112:105   //  
delayMicroseconds(2);
...
send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 40:33  -48:41//  
send_char_without(0B00101101);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
//Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
//Note: the Dq is to define the pins to Segments or Analog pins
//Last  bit is to define first group or second! 
delayMicroseconds(2);
...
digitalWrite(VFD_ce, HIGH); //
// On the 7582 of Sanyo the message 
send_char_without(0B00001100);  send_char_without(0B00000000); // 64:57  -72:65//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 80:73  -88:81//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 96:89 -104:97//  
send_char_without(0B10000000);  //112:105   //  
delayMicroseconds(2);
...
send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 40:33  -48:41//  
send_char_without(0B00100011);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
//Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
//Note: the Dq is to define the pins to Segments or Analog pins
//Last  bit is to define first group or second! 
delayMicroseconds(2);
...
digitalWrite(VFD_ce, HIGH); //
// On the 7582 of Sanyo the message 
send_char_without(0B00001001);  send_char_without(0B00000000); // 64:57  -72:65//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 80:73  -88:81//  
send_char_without(0B00000000);  send_char_without(0B00000000); // 96:89 -104:97//  
send_char_without(0B10000000);  //112:105   //  
delayMicroseconds(2);
      ...
      // 
          ...
          //The next switch finalize the burst of bits -41:48//  
              switch (blockBit){ //Last 2 bits is "DD" data direction, and is used to mark the 4 groups of 36 bits, 00, 01, 10, 11.                                 
                case 0: send_char_without(0B00100000 | Ag); break; //Block 00
                case 1: send_char_without(0B10000000 | Ag); break; //Block 01
              }
      delayMicroseconds(1);
      digitalWrite(VFD_ce, LOW); //                   
}
